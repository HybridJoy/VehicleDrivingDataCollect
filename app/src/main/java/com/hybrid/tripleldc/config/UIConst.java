...
public class UIConst {
    ...
    public static class ToastMessage {
        public static String DEFAULT_MESSAGE = "请求成功";

        public static String DEFAULT_ERROR_MESSAGE = "操作错误";
        public static String ERROR_RESOURCE_NOT_FIND = "请求的资源不正确！";
        public static String ERROR_SERVER_MISTAKE = "服务器错误";
    }
}
